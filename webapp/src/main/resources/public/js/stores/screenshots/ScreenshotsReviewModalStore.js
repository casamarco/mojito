...
class ScreenshotsReviewModalStore {
    ...
    openWithScreenshot(screenshotIdx) {
        console.log("ScreenshotsReviewModalStore::openWithScreenshot", screenshotIdx);
        this.show = true;
    ...
    changeStatus(status) {
        console.log("ScreenshotsReviewModalStore::changeNewStatus", status);
        this.status = status;
        this.saveDisabled = this.isSaveDisabled();
    }

    changeComment(comment) {
        console.log("ScreenshotsReviewModalStore::changeNewComment", comment);
