...
class ScreenshotsLocaleStore {
    ...
    getAllRepositories() {
//         console.log("ScreenshotsLocaleStore::getAllRepositories");
...
//        console.log("ScreenshotsLocaleStore::changeSelectedRepositoryIds::beforeWait");
        this.waitFor(ScreenshotsRepositoryStore);
//        console.log("ScreenshotsLocaleStore::changeSelectedRepositoryIds::afterWait");
//   console.log("ScreenshotsLocaleStore::changeSelectedRepositoryIds::store");
//   console.log(ScreenshotsRepositoryStore.getState());
...
//        console.log("ScreenshotsLocaleStore::changeSelectedBcp47Tags");
