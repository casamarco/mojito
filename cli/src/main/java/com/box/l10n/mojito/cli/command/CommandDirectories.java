...
public class CommandDirectories {
    ...
    public List<Path> listFilesWithExtensionInSourceDirectory(String... extensions) throws CommandException {
        ...
        final PathMatcher pathMatcher = FileSystems.getDefault().getPathMatcher(buildGlobPatternForFileWithExtension(extensions));
    ...
    /**
     * Build a Glob pattern that matches files with given extension (case 
     ...
     */
    String buildGlobPatternForFileWithExtension(String... extensions) {
